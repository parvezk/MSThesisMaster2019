...
An example of this is the autonomous vehicles car that rely on an enriched visual dataset to construct their own map real-time and navigate the roads[]. Here, each frame of the video collected by a self-driving car must be enriched with data to identify objects such as a road sign, pedestrian, tree or sidewalks, in every frame.

According to AI expert and MIT Sloan professor Erik Brynjolfsson[], there has been a radical improvement in the development of algorithms in computer science. Some of them were first introduced 30 or 40 years ago, they have now been tweaked and improved drastically by faster computers and massive volumes of data. With this, It became more convenient to figure out what works and doesn't work over time.
