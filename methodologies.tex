...
%visualization is a potentially a powerful technique to fill such a critical need that can be used to see through the black box model and deconstruct it to understand what features the network has learned during inference.
...
\footnotetext{Visual Geometry Group, University of Oxford http://www.robots.ox.ac.uk/~vgg/}
